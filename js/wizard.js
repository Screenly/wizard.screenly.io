...
$('#generateconfig').click(function()
{
  ...
  var has_disable_network_manager = $('#disable-network-manager').is(":checked");
  ...
  if(has_wired == true || has_wifi == true) {
    v2Str += "network:\r\n";
    v2Str += "  version: 2\r\n";
    if(!(has_disable_network_manager)) {
